...
Achievements::Achievements() {
    _achievements = {
        Achievement(11, DC::D1, DC::D1,
            [](GameState& st) {return st.AD()[1].getPurchases() > 0;}),
        Achievement(12, DC::D1, DC::D1,
            [](GameState& st) {return st.AD()[2].getPurchases() > 0;}),
        Achievement(13, DC::D1, DC::D1,
            [](GameState& st) {return st.AD()[3].getPurchases() > 0;}),
        Achievement(14, DC::D1, DC::D1,
            [](GameState& st) {return st.AD()[4].getPurchases() > 0;}),
        Achievement(15, DC::D1, DC::D1,
            [](GameState& st) {return st.AD()[5].getPurchases() > 0;}),
        Achievement(16, DC::D1, DC::D1,
            [](GameState& st) {return st.AD()[6].getPurchases() > 0;}),
        Achievement(17, DC::D1, DC::D1,
            [](GameState& st) {return st.AD()[7].getPurchases() > 0;}),
        Achievement(18, DC::D1, DC::D1,
            [](GameState& st) {return st.AD()[8].getPurchases() > 0;}),
